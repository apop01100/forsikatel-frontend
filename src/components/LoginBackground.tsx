...
const BackgroundLogin = ({ children }: { children: React.ReactNode}) => {
  return (
    <div className="flex flex-col justify-between items-stretch noisy-gradient-background sm:bg-neutral-50 sm:pt-0 gap-2">
      <img src={mushafLogo} className="block sm:hidden object-cover z-10 relative top-12 left-1/4 h-60 w-56" />
      <div className="sm:flex">
        <div className="flex flex-col pt-24 px-8 gap-14 w-full h-full bg-neutral-50 rounded-ss-[100px] sm:flex-1">
